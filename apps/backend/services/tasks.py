...
@celery_app.task(name="apps.backend.services.tasks.save_complexity_score_to_json")
def save_complexity_score_to_json(previous_task_result=None):
    # Initialize a ComplexityAnalyzer instance
    complexity_analyzer = ComplexityAnalyzer()
